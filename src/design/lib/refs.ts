// Ayah-reference helpers shared by the reference pages (Duas, Prophet Stories,
// Parables, Commands & Prohibitions, Warnings, Character, Legal Rulings). Ported
// verbatim from the web frontend (frontend/src/lib/refs.ts). A "ref" is
// "surah:ayah" or a single-surah range "surah:start-end".
