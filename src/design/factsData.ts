...
export const MENTIONS: Record<string, MentionItem[]> = {
  prophets: [
    ...
    { name: "Idris", refs: ["19:56-57", "21:85-86"] },
    { name: "Nuh", refs: ["7:59-64", "11:25-48", "23:23-30", "71:1-28"] },
    { name: "Hud", refs: ["7:65-72", "11:50-60", "26:123-140"] },
    { name: "Salih", refs: ["7:73-79", "11:61-68", "26:141-159", "91:11-15"] },
    ...
    { name: "Ayyub", refs: ["21:83-84", "38:41-44"] },
    { name: "Shuayb", refs: ["7:85-93", "11:84-95", "26:176-191", "29:36-37"] },
    { name: "Musa", refs: ["2:49-61", "7:103-137", "20:9-98", "28:3-46"] },
    { name: "Harun", refs: ["20:29-36", "20:90-94", "25:35", "37:114-122"] },
    { name: "Dhul-Kifl", refs: ["21:85-86", "38:48"] },
  ...
  nations: [
    ...
    { name: "People of the Cave", refs: ["18:9-26"], total: 1, forms: [["أصحاب الكهف", 1]] },
    ...
    { name: "People of Ukhdud", refs: ["85:4-10"], total: 1, forms: [["أصحاب الأخدود", 1]] },
  ...
  angels: [
    ...
    { name: "Angels generally", refs: ["2:30-34", "3:39-42", "8:9-12", "16:2", "35:1", "66:6"], total: 81, forms: [["الملائكة", 53], ["ملائكة", 15], ["ملك / ملكا", 11], ["ملكين", 1], ["الملكين", 1]] },
  ],
  scriptures: [
  ...
  places: [
    ...
    { name: "Kaaba / Sacred House", refs: ["2:125-127", "5:97", "22:26-29"], total: 13, forms: [["الكعبة", 2], ["البيت الحرام", 2], ["البيت العتيق", 2], ["البيت", 7]] },
...
export const NATURAL_SIGNS: QuranTermMention[] = [
  ...
  { id: "plants", name: "Plants / vegetation", group: "earth", arabicTerms: ["نبات", "زرع", "أنبتنا"], refs: ["6:99", "10:24", "16:11", "18:45", "39:21", "80:27-31"], note: "General references to vegetation Allah causes to grow, including derived growth forms (e.g. fa-anbatnā, 'We caused to grow', in 80:27)." },
